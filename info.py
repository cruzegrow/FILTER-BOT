...
# Bot information
SESSION = environ.get('SESSION', 'MovieMaxBot')
API_ID = int(environ.get('24694117', ''))
API_HASH = environ.get('1347da17a63b33d913acb43f9b18b964', '')
BOT_TOKEN = environ.get('7370761566:AAEkBBPLKgfMCayJLm98aemRiDav5vFCqik', "")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1839923964').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('-1002601350575', ''))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002686866963') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002462290553')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002462290553')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002321003157')).split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002661324052').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('mongodb+srv://cruzegrow:<db_password>@cruzegrow.0zyaz.mongodb.net/?retryWrites=true&w=majority&appName=cruzegrow', "")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('cruzegrow', "techvjclonefilterbot")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Zfmovierequest')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/moviemaxog')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'vj_bot_disscussion') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/VK_EARNER')
